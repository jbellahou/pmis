...
$(document).ready(function () {
    ...
    $('.summernote3000').summernote({
        placeholder: 'Type up to 3000 characters (click Code View to see all of the characters including HTML tags).',
        maxTextLength: 3000,
        codemirror: { // codemirror options
            theme: 'monokai'
        }
    ...
    $('#sigma-container').height($(window).height());
});